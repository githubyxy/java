...
public class MyDateUtils {
	...
	public static void main(String[] args) {
		System.out.println(addDate(new Date(), 1L, ChronoUnit.YEARS));
		System.out.println(addDate(new Date(), 1L, ChronoUnit.MONTHS));
		System.out.println(addDate(new Date(), 1L, ChronoUnit.DAYS));
		System.out.println(addDate(new Date(), 1L, ChronoUnit.HOURS));
		System.out.println(addDate(new Date(), 2L, ChronoUnit.MINUTES));
		System.out.println(addDate(new Date(), 10L, ChronoUnit.SECONDS));
	}
